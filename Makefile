...
row_decoders2: ## Build the row_decoders2 design
	librelane my_designs/row_decoders2/config.yaml --pdk ${PDK} --pdk-root ${PDK_ROOT} --manual-pdk --skip KLayout.DRC --skip Magic.DRC
.PHONY: row_decoders2
